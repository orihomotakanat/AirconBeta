...
class CloudLogicAPIInvokeViewController: UIViewController, UITextFieldDelegate { //Delegate method反映のためにUITextFieldDelegate必要 (CloudLogicAPI...classはUIViewControllerとUITextFIeldDelegate classを継承している
    ...
    override func viewDidLoad() {
        ...
        queryStringParameters.delegate = self
        methodPath.delegate = self
